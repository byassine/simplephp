pipeline {
    ...
    stages {
        ...
        stage('Sonar Analyse') {
            steps {
               sh ''' $SCANNER_HOME/bin/sonar-scanner -Dsonar.url=http://10.97.232.219:9000/ -Dsonar.login=squ_0a27028face8c62b864ff7b2efdff5131a129d71 -Dsonar.projectName=test \
